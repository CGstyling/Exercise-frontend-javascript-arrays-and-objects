...
const makingAString = "Hoi! ik ben " + aboutMe.name + ", ik ben " + aboutMe.age + " jaar oud.";

console.log( makingAString );
...
const makingAString1 = "De smeg Waterkoker is gemaakt van " + product.material[0] + " en " + product.material[1];
console.log( makingAString1 );
