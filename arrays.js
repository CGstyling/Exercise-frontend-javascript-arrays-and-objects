...
// ==========================================
const years = [ 2012, 1013, 1022, 3000, 4000 ];
console.log( years );
console.log( years[ 4 ] );
...
// ==========================================
let hobbiesVanMij = [ "Koken", "Lezen", "Reizen" ];
console.log( hobbiesVanMij );
...
// ==========================================
const numbersOfThisArray = [ 3, 4, 5, 7, 2 ];
console.log( numbersOfThisArray[0] );
...
const colorsOFThisArray = [ "groen", "geel", "Rood", "Paars", "blauw", "oranje" ];
console.log( colorsOFThisArray.length -1 );
console.log( colorsOFThisArray[4] );
console.log( colorsOFThisArray[1] );
...
// ==========================================
const ingridientsOfThisArray = ["bladerdeeg", "knoflook", "spinazie"];

ingridientsOfThisArray[0] = "Lasagne Bladeren";
console.log( ingridientsOfThisArray );
console.log( ingridientsOfThisArray.length );